...
public class FunctionalCalculator {
    ...
    public static void main(String[] args) {
        ...
        if (number2 !=0){
            ...
            Map<String,Integer> result = Map.of("Addition",FunctionalCalculator.calculate(number1,number2,add),
                    "subtraction",FunctionalCalculator.calculate(number1,number2,sub),"multiplication",FunctionalCalculator.calculate(number1,number2,mult),
                            "division", FunctionalCalculator.calculate(number1,number2,div));
            ...
            System.out.println("--------------Map Format Output--------------");
